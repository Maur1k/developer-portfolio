...
export default function Experience() {
  ...
  return (
    <section className="min-h-screen py-24 px-4 md:px-8 relative">
      <div className="absolute inset-0 overflow-hidden pointer-events-none"><div className="absolute top-40 left-0 w-96 h-96 bg-gradient-to-br from-orange-500/5 to-amber-400/5 rounded-full blur-3xl"></div></div>
